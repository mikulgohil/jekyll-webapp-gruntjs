...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        bootstrapDir: 'bower_components/bootstrap-sass-official/vendor/assets/javascripts/bootstrap',
        // Project settings
        config: config,
        ...
        bowerInstall: {
            app: {
                src: ['<%= config.app %>/_includes/footer.html'],
        ...
        useminPrepare: {
            ...
            html: '<%= config.app %>/_layouts/default.html'
        },
        ...
        // By default, your `_layouts/footer.html`'s <!-- Usemin block --> will take care of
        ...
        /* uglify: {
            dist: {
                jquery: {
                    files: {
                        '<%= config.dist %>/scripts/vendor.js': '<%= config.app %>/bower_components/jquery/dist/jquery.js'
                    }
                },
                bootstrap: {
                    files: {
        ...
        uglify: {
            jquery: {
                files: {
                    '<%= config.dist %>/scripts/vendor.js': 'bower_components/jquery/dist/jquery.js'
                }
            },
            /* bootstrap: {
                files: {
                    '<%= config.dist %>/scripts/plugins.js': '<%= config.dist %>/scripts/plugins.js'
                }
            }*/
        },
        ...
        concat: {
            ...
            bootstrap: {
                ...
                dest: '<%= config.dist %>/scripts/plugins.js'
            }
        },
